...
class AnimeManager:
    ...
    def _choose_duplicate_winner(
        ...
        # Anime MPV-linked item is enough evidence. Otherwise preserve both.
    ...
    def cleanup_duplicate_torrents(self) -> int:
        """Remove only clear incomplete duplicate torrents managed by Anime MPV.

        Duplicate identity comes from Anime MPV's anime/episode/batch tags. Every
        ...
        try:
            ...
            for identity, duplicates in groups.items():
                ...
                # Make the retained torrent the canonical Anime MPV-linked copy,
    ...
    def _remove_missing_episode_rows(self, active_hashes: set[str]) -> int:
        ...
        qBittorrent deletion is often performed outside Anime MPV. The downloads
    ...
    def process_subtitle_jobs(
        ...
        *,
        ...
        for job_index, job in enumerate(jobs):
            ...
            env = dict(os.environ)
            env["ANIME_MPV_CONFIG"] = str(self.config.config_path)
        ...
        for row in due:
            ...
            try:
                ...
                if torrent_hash and self.downloads_enabled():
                    ...
                    # mapping. A due, watched Anime MPV episode is safe to remove
    ...
    def _repair_brand_moved_subtitle_selections(self) -> int:
        ...
        The 0.6.57 Anime MPV -> pudge migration moved the cache directory but
        older SQLite rows and subtitle-history JSON still contained absolute
        ``~/Library/Caches/anime-mpv/...`` paths. A later integrity pass could
