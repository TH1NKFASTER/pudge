...
class PathsConfig:
    ...
    # An empty list means that Anime MPV only checks the video's own directory
...
def load_config(path: Path | None = None) -> AppConfig:
    ...
    cfg = AppConfig(
        ...
        qbittorrent=QBittorrentConfig(
            ...
            password=os.getenv(
                "ANIME_MPV_QBITTORRENT_PASSWORD", str(qbittorrent.get("password", ""))
            ),
            api_key=os.getenv(
                "ANIME_MPV_QBITTORRENT_API_KEY", str(qbittorrent.get("api_key", ""))
            ),
        ...
        llm=LLMConfig(
            ...
            api_key=os.getenv("ANIME_MPV_LLM_API_KEY", str(llm.get("api_key", ""))).strip(),
