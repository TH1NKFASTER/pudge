...
_BRAND = _load_brand()
APP_NAME = _BRAND.get("APP_NAME", "pudge")
APP_SLUG = _BRAND.get("APP_SLUG", "pudge")
APP_BUNDLE_ID = _BRAND.get("APP_BUNDLE_ID", "com.pudge.app")
APP_CLI = _BRAND.get("APP_CLI", "pudge")
APP_AGENT_CLI = _BRAND.get("APP_AGENT_CLI", "pudge-agent")
APP_ENV_PREFIX = _BRAND.get("APP_ENV_PREFIX", "PUDGE")
