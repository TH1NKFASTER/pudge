...
(() => {
  ...
  document.addEventListener('click', async event => {
    ...
    if (type === 'delete-audio') {
      if(!confirm(ru()?'Удалить аудиокнигу из Pudge? Исходные файлы останутся на диске.':'Remove this audiobook from Pudge? Source files will stay on disk.'))return;
