...
def test_final_complete_cluster_pass_removes_runtime_wide_amalgam() -> None:
    specs = [
    ...
    wide = {
        "x": 0.467684, "y": 0.872333, "width": 0.425158, "height": 0.100333,
        "orientation": "vertical", "confidence": 0.3,
        "text": "おれはなんかもう．．．っ",
    }
